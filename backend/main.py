...
async def perguntar(pergunta: Pergunta):
    ...
    if conhecimento:
        ...
        prompt = prompt_base
    prompt += 'Explique passo a passo seu raciocínio antes de dar a resposta final e faça o máximo para relacionar essa pergunta à UFS (Universidade Federal de Sergipe).'
